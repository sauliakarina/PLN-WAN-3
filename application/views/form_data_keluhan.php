                ...
                <div class="col-md-12">
                  <!--   Kitchen Sink -->
                            ...
                            <div class="table-responsive" style="margin-top: 20px">
                                ...
                                <form action="<?php echo base_url();?>c_keluhan/tampil_searchkeluhan">
                                  <button class='btn btn-outline-primary' type='submit'><i class="fas fa-search" style="margin-right: 10px"></i>Menu Pencarian</button>
                                </form>
                            </div>
                        </div>
                    </div>
